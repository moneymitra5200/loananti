...
"[project]/Desktop/reallll/src/hooks/useAutoRefresh.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAutoRefresh({ onRefresh, intervalMs = 30_000, enabled = true, visibilityThrottleMs = 15_000 }) {
    const [lastUpdated, setLastUpdated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const onRefreshRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(onRefresh);
    const lastRefreshTimeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    ...
    const doRefresh = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!enabled) return;
        try {
...
function useRelativeTime(date) {
    const [label, setLabel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!date) {
            setLabel('');
            return;
...
"[project]/Desktop/reallll/src/contexts/RefreshContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const RefreshContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])({
    refreshKey: 0,
    triggerRefresh: ()=>{},
...
function RefreshProvider({ children }) {
    ...
    const [lastRefreshedAt, setLastRefreshedAt] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    // Throttle: max one refresh per 2 seconds to prevent cascade re-renders
    const lastFireRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(RefreshContext.Provider, {
        value: {
            refreshKey,
            triggerRefresh,
            lastRefreshedAt
...
function useRefresh() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(RefreshContext);
}
}),
...
"[project]/Desktop/reallll/src/utils/accountingExport.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function exportAsImage(elementId, filename) {
    try {
        const html2canvas = (await __turbopack_context__.A("[project]/Desktop/reallll/node_modules/html2canvas/dist/html2canvas.esm.js [app-ssr] (ecmascript, async loader)")).default;
        const el = document.getElementById(elementId);
        if (!el) {
...
async function exportAsPDF(elementId, filename, title) {
    try {
        const { jsPDF } = await __turbopack_context__.A("[project]/Desktop/reallll/node_modules/jspdf/dist/jspdf.node.min.js [app-ssr] (ecmascript, async loader)");
        const html2canvas = (await __turbopack_context__.A("[project]/Desktop/reallll/node_modules/html2canvas/dist/html2canvas.esm.js [app-ssr] (ecmascript, async loader)")).default;
        const el = document.getElementById(elementId);
        if (!el) return;
        const canvas = await html2canvas(el, {
...
//# sourceMappingURL=Desktop_reallll_src_b0f881b9._.js.map