...
function useRealtime(options = {}) {
        ...
        "useRealtime.useEffect": ()=>{
            ...
            const startDelay = setTimeout({
                "useRealtime.useEffect.startDelay": ()=>{
                    ...
                    }["useRealtime.useEffect.startDelay"], pollInterval);
                }
            }["useRealtime.useEffect.startDelay"], 5000); // wait 5s after mount before first poll
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useRealtime.useEffect": ()=>{
            ...
            return ({
                "useRealtime.useEffect": ()=>document.removeEventListener('visibilitychange', handleVisibilityChange)
            })["useRealtime.useEffect"];
        }
    }["useRealtime.useEffect"], [
        userId
...
//# sourceMappingURL=Desktop_reallll_src_01abb256._.js.map