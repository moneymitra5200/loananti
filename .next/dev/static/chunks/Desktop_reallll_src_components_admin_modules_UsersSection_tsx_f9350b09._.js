...
function EditUserDialog({ user, open, onClose, onSave }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$reallll$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "EditUserDialog.useState": ()=>{
            if (user) {
                setName(user.name || '');
                setPhone(user.phone || '');
                setPassword('');
...
_s(EditUserDialog, "ovm484NB6eJFxPSoaSrkUq1VoXQ=");
_c = EditUserDialog;
